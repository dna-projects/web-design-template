        ...
        <>
            <div className='banner-image flex justify-center self-center relative w-full h-[400px] px-4 lg:h-[600px] xl:max-w-[90%]'>
                ...
                <div className='flex flex-col self-center text-center z-10'>
                    <h2 className='self-center text-[35px] text-white font-extrabold tracking-tight leading-tight min-w-60 max-w-80 mb-8 px-4 md:px-0 md:text-[45px]'>Get It Done With Us Today</h2>
