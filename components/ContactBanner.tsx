        ...
        <>
            <div className='banner-image flex justify-center self-center relative w-full h-[400px] px-4 lg:h-[600px] xl:max-w-[90%]'>
                ...
                <div className='flex flex-col self-center text-center z-10'>
                    <h1 className='self-center text-[35px] text-white font-bold tracking-tight leading-tight w-80 mb-8 md:text-[45px]'>Get It Done With Us Today</h1>
                    ...
                    <Link href='/contact' className='self-center'>
                        <button className='border-2 border-yellow-500 bg-yellow-500 font-bold w-[175px] px-5 py-3 hover:bg-white hover:border-white duration-200'>GET IN TOUCH</button>
                    </Link>
                </div>
            </div>
        </>
